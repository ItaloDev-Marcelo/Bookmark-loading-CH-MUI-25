...
export default function FeaturesSection() {
    ...
    return (
    <Section modole='py-[4em] my-4 lg:my-15 flex flex-col justify-center items-center text-center' id=''>
        <div className='pb-5 lg:pb-10 lg:px-[22em]'>
              <h2 className='text-[1.7em] lg:text-[2.5em] my-4'>Features</h2>
              <Paragraph Text={pText} textStyle='my-3' />
          </div>
          <TabSlider/>
    </Section>
    )
