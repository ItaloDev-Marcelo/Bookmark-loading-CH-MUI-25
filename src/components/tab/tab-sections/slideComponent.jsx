...
const SlideComponent = ({image, text, title, btnTitle }) => {
     ...
     return (
        <section className='flex flex-col lg:flex-row mt-10 lg:justify-between '>
            ...
            <div className='lg:w-[400px] flex flex-col text-center lg:items-start lg:text-left'>
                ...
                <ButtonCamp title={btnTitle} btnStyle='bg-blue-400 rounded-[7px] font-semibold h-[45px] cursor-pointer hover:bg-blue-300 p-2 text-white' />
            </div>
        </section>
     )
}
